        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="glass-card p-8">
                <form method="POST" action="{{ route('admin.profile.update') }}">
                    ...
                    <h3 class="text-xl font-semibold mb-4 neon-text">Change Password</h3>
            ...
            <div class="glass-card p-8 mt-6 border-red-500/30">
                ...
                <form method="POST" action="{{ route('admin.profile.destroy') }}" onsubmit="return confirm('Are you sure you want to delete your account? This cannot be undone.');">
                    @csrf
                    @method('DELETE')
